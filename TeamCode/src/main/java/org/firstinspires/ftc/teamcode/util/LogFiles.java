...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double trackingTicksPerRev = DriveConstants.TICKS_PER_REV;
        public double trackingWheelRadius = DriveConstants.WHEEL_RADIUS;
        public double trackingGearRatio = DriveConstants.GEAR_RATIO;
        public double trackingLateralDistance = DriveConstants.TRACK_WIDTH;
        public double trackingForwardOffset = 0;
