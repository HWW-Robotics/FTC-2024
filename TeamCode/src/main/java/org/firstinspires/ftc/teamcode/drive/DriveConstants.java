...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0.1, 0.1, 0.01, getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV));
    ...
    public static double TRACK_WIDTH = 19.1; // in
